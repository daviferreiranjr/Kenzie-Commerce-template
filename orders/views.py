...
from .permissions import AuthenticationSeller
...
class OrderView(CreateAPIView):
    ...
    permission_classes = [IsAuthenticated, AuthenticationSeller]
...
class OrderUpdateRetriverView(RetrieveUpdateAPIView):
    authentication_classes = [JWTAuthentication]
    permission_classes = [IsAuthenticated, AuthenticationSeller]
